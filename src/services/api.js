  ...
  export const assignGrievance = async (id, driverId, lat = null, lng = null) => {
    const payload = { driverId };
    // Include complaint coordinates so the backend can make them available
    // on the driver-assigned complaints endpoint (GET /complaints/driver-assigned).
